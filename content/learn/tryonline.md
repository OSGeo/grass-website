...
### Try Jupyter notebooks with GRASS on Binder

<div class="container">
<div class="row mt-20">
<div class="col-lg-6 text-center">
<a href="https://mybinder.org/v2/gh/wenzeslaus/try-grass-in-jupyter/master"><img class="bsh" src="../../images/other/GRASS_mybinder_jupyter_intro.png" width="89%" alt="GRASS Jupyter intro"></a>
</div>
<div class="col-lg-6">
<p>The <b><a href="https://jupyter.org/binder">Binder</a></b> project offers reproducible, shareable, interactive computing environments. From the <b>GRASS</b> community, GitHub repositories are available to launch a <b>GRASS</b> computing environment with sample data and working examples.
...
<b>GRASS</b> can be launched as a rollApp. Click on the screenshot to get to the launch site.</p>
<div class="alert rounded-0 alert-default">
